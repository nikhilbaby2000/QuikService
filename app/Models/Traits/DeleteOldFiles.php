 ...
 * Set the 'storageDisk' property to specify the file storage disk, will use the default disk if not.
...
trait DeleteOldFiles
{
    ...
    protected static function deleteOldFiles(Model $model, $updating = false)
    {
        ...
        Storage::disk($model->storageDisk)->delete(array_filter($filesToDelete));
    }
}
