...
return [
    ...
    */
    ...
    'providers' => [
        ...
        'smsindiahub' => [
            'class' => \App\QuikService\Libraries\SMS\Providers\SMSIndiaHub::class,
        ...
        'msg91' => [
            'class' => \App\QuikService\Libraries\SMS\Providers\MSG91::class,
            'authkey' => env('MSG91_AUTH_KEY'),
            'sender_id' => env('SMS_SENDER_ID', $defaultSenderId),
        ],

        'trap' => [
            'class' => \App\QuikService\Libraries\SMS\Providers\SMSTrap::class,
            'email' => env('SMS_TRAP_EMAIL'),
        ],

        'log' => [
            'class' => \App\QuikService\Libraries\SMS\Providers\SMSLog::class,
        ],
