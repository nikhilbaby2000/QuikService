...
<div class="d-flex">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:9396751" href="/notifications">
        ...
        <li class="dropdown">
            <details class="details-overlay details-reset d-flex px-2 flex-items-center">
                <summary class="HeaderNavlink" aria-label="Create new…" data-ga-click="Header, create new, icon:add" aria-haspopup="menu">
                    ...
                    <span class="dropdown-caret mt-10"></span>
                </summary>
        ...
        <li class="dropdown">
            ...
            <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
                <summary class="HeaderNavlink name mt-1" aria-label="View profile and more" data-ga-click="Header, show menu, icon:avatar" aria-haspopup="menu">
                    <img alt="@nikhilbaby2000" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/9396751?s=40&amp;v=4" height="20" width="20">
                    <span class="dropdown-caret mt-10"></span>
                </summary>
                <details-menu class="dropdown-menu dropdown-menu-sw" role="menu">
                    <ul>
    ...
    <!-- '"` --><!-- </textarea></xmp> --><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="Xh1hgcaYm+MurnpsBM6C14HRc6CcipjeBml5df26fFxlhJz3dUPZWGnECt4aYi5/eOpB33pZbizF+TCtvNyYsg==">
